...
export default async function AnnualReportDetailPage({ params }: Props) {
  const { slug } = await params
  const report = await getReport(slug)
  if (!report) notFound()
                      ...
                      <div className="space-y-3">
                        ...
                        {(report.downloadCount ?? 0) > 0 && (
                          <div className="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span>{report.downloadCount.toLocaleString()} downloads</span>
                          </div>
                        )}
                      </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl font-bold text-gray-900">Other Annual Reports</h2>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <h3 className="font-bold text-gray-900 mt-1 group-hover:text-primary-900 transition-colors line-clamp-2">{r.title}</h3>
