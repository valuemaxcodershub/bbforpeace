        ...
        /* ────────────── PROGRAMMES / FOCUS ─────────────── */
        {
          ...
          fields: [
            ...
            { name: 'focusBackgroundImage', type: 'upload', relationTo: 'media', label: 'Background Image' },
            {
              ...
              defaultValue: [
                { title: 'Youth & Women Peace and Security', description: 'Empowering young people and women as active agents of peace through capacity building and advocacy.', icon: 'Users', link: '/programmes/youth-women-peace-security', gradient: 'from-violet-600 via-purple-600 to-indigo-700' },
                { title: 'Conflict Management & Peacebuilding', description: 'Building skills to identify and handle conflicts sensibly, fairly, and efficiently.', icon: 'Shield', link: '/programmes/conflict-management', gradient: 'from-blue-600 via-indigo-600 to-blue-800' },
                { title: 'Prevention of Violent Extremism', description: 'Proactive measures to combat extremism through education and community engagement.', icon: 'AlertTriangle', link: '/programmes/preventing-violent-extremism', gradient: 'from-orange-500 via-red-500 to-rose-600' },
                { title: 'Governance & Accountability', description: 'Promoting inclusive, transparent, and accountable governance through civic awareness.', icon: 'Scale', link: '/programmes/governance-accountability', gradient: 'from-emerald-600 via-teal-600 to-cyan-700' },
                { title: 'Climate & Environmental Security', description: 'Integrating climate action with peacebuilding to address resource conflicts.', icon: 'Leaf', link: '/programmes/climate-environmental-security', gradient: 'from-green-600 via-emerald-600 to-teal-700' },
                { title: 'Peace Education', description: 'Equipping communities with knowledge and skills for peaceful conflict resolution.', icon: 'BookOpen', link: '/programmes/peace-education', gradient: 'from-amber-500 via-yellow-500 to-orange-500' },
              ],
            },
          ],
        },
